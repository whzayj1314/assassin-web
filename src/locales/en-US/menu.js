export default {
  ...
  'menu.system.app': 'Microservices Management',
  'menu.system.tokenrule': 'TokenRule Management',
  'menu.system.client': 'Client Management',
  'menu.rbac': 'RBAC Management',
  'menu.rbac.access': 'Access Management',
  'menu.rbac.role': 'Role Management',
  'menu.rbac.user': 'User Management',
  'menu.tenant': 'Muti Tenant Management',
  'menu.tenant.template': 'Product Template Management',
  'menu.tenant.tenant': 'Tenant Management',
